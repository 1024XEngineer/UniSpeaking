...
public final class InterviewErrorCode {
	...
	public static final String INTERVIEW_REPORT_NOT_FOUND = "INTERVIEW_REPORT_NOT_FOUND";
	public static final String INTERVIEW_REPORT_PERSISTENCE_FAILED = "INTERVIEW_REPORT_PERSISTENCE_FAILED";
	public static final String INTERVIEW_RECORDING_NOT_FOUND = "INTERVIEW_RECORDING_NOT_FOUND";
	public static final String INTERVIEW_RECORDING_PERSISTENCE_FAILED = "INTERVIEW_RECORDING_PERSISTENCE_FAILED";
	public static final String INTERVIEW_AUDIO_INVALID = "INTERVIEW_AUDIO_INVALID";
