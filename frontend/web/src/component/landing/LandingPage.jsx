...
export function LandingPage({ onStart, onLogin, onWeb }) {
  ...
  return (
    <main className="landing-page" id="top">
      ...
      <section className="landing-signal" aria-label="产品能力概览" data-reveal>
        <div className="landing-container landing-signal__inner"><span>从今天开始练习</span><div className="landing-signal__items"><span><Microphone weight="bold" />实时语音</span><span><BookOpenText weight="bold" />场景学习</span><span><ShieldCheck weight="bold" />隐私优先</span><span><DeviceMobile weight="bold" />Web + Mobile</span></div></div>
      </section>
